        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (let index = 0; index < data.length; index++) {
                    ...
                    rows += "<tr><td style=\"text-align:center\">" + name + "</td><td style=\"text-align:center\">" + code + "</td><td style=\"text-align:center\">" + credit + "</td><td style=\"text-align:center\">" + dept + "</td><td style=\"text-align:center\">" + level + "</td><td style=\"text-align:center\">" + term + "</td>";
                }
                console.log(rows);
